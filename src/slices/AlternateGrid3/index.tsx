...
export type AlternateGrid3Props =
  SliceComponentProps<Content.AlternateGrid3Slice>;

const AlternateGrid3 = ({ slice }: AlternateGrid3Props): JSX.Element => {
  return (
    <section
