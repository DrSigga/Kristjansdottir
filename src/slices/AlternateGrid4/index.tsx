...
export type AlternateGrid4Props =
  SliceComponentProps<Content.AlternateGrid4Slice>;

const AlternateGrid4 = ({ slice }: AlternateGrid4Props): JSX.Element => {
  return (
    <section
